...
export const GUEST_FILESYSTEM_PYTHON = [
  ...
  "                    pass  # The competing entry must still pass the no-follow directory open.",
  "                next_fd = open_dir(segment, dir_fd=current_fd)",
  "            os.close(current_fd)",
  "            current_fd = next_fd",
  "        return current_fd",
  ...
  "        # A mode of 0 is not searchable. Create the temporary directory",
  "        # writable, publish it, then restore the source mode. Renaming a",
  "        # mode 0 directory is EPERM on some macOS versions.",
  "        temp_dir_name = create_temp_dir(dst_parent_fd, 0o700)",
  "        copied_children = []",
  "        temp_dir_fd = None",
  "        src_dir_fd = None",
  "        try:",
  ...
  "                try:",
  "                    os.chmod(dst_basename, source_mode, dir_fd=dst_parent_fd, follow_symlinks=False)",
  "                except Exception:",
  "                    try:",
  "                        remove_tree(dst_parent_fd, dst_basename)",
  "                    except FileNotFoundError:",
  ...
  "    if stat.S_ISLNK(src_stat.st_mode):",
  "        link_target = os.readlink(src_basename, dir_fd=src_parent_fd)",
  "        temp_dir_name, temp_dir_fd = create_staging_dir(dst_parent_fd)",
  "        try:",
  "            os.symlink(link_target, 'link', dir_fd=temp_dir_fd)",
  "            os.replace('link', dst_basename, src_dir_fd=temp_dir_fd, dst_dir_fd=dst_parent_fd)",
  "        finally:",
  "            try:",
  "                try:",
  "                    os.unlink('link', dir_fd=temp_dir_fd)",
  "                except FileNotFoundError:",
  "                    pass",
  "            finally:",
  "                os.close(temp_dir_fd)",
  "            os.rmdir(temp_dir_name, dir_fd=dst_parent_fd)",
